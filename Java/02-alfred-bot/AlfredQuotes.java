...
    */
    public String dateAnnouncement() {
        // YOUR CODE HERE
        String pattern = "EEEEE, MMMMM d, yyyy";
...
    * Inputs: String
    * Return Type: String
    * Description: Returns a question regarding Batman's vehicle
    */
    public String readyTransportation(String transportation) {
        return "Shall I ready the Bat-" + transportation + ", sir?";
}
}
